$('a#mob').each(function(){ this.href=this.href.replace('https://docs.google.com/open?id=', 'com.automatique.dz.univ&')});
$('a#mob').each(function(){ this.href=this.href.replace('https://drive.google.com/open?id=', 'com.automatique.dz.univ&')});

   window.onload = function() {
     Swal.fire({
  icon: 'error',
  title: '<a href="market://details?id=com.automatique.dz.univ" style=" font-family:exo 2;color: #000; ">Oops...</a>',
...
const bannerConfig = [
    adUnitId = "ca-app-pub-2103221276430615/7141800527",
...
let showBannerAd = () => {
  ...
  adUnitId = "ca-app-pub-2103221276430615/8770789963",
