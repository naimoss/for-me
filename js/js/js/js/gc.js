$('a#mob').each(function(){ this.href=this.href.replace('https://docs.googfle.com/open?id=', 'market://details?id=com.genie.civile.dz.univ&')});
$('a#mob').each(function(){ this.href=this.href.replace('https://drive.googfle.com/open?id=', 'market://details?id=com.genie.civile.dz.univ&')});
...
let showBannerAd = () => {
  ...
  adUnitId = "ca-app-pub-2103221276430615/4357900688",
