...
document.addEventListener('deviceready', async () => {
    ...
    try {
        ...
        banner = new admob.BannerAd({
            adUnitId: 'ca-app-pub-2103221276430615/9133738073', // Replace with your test or production Ad Unit ID
            size: { height: 60 }
        });
...
document.addEventListener('deviceready', async () => {
    ...
    try {
        interstitial = new admob.InterstitialAd({
            adUnitId: 'ca-app-pub-2103221276430615/1607134670', // Replace with your interstitial Ad Unit ID
        });
