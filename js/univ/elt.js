...
document.addEventListener('deviceready', async () => {
    ...
    try {
        ...
        banner = new admob.BannerAd({
            adUnitId: 'ca-app-pub-2103221276430615/9770133171', // Replace with your test or production Ad Unit ID
            size: { height: 60 }
        });
...
document.addEventListener('deviceready', async () => {
    ...
    try {
        // Initialize the InterstitialAd instance
        interstitial = new admob.InterstitialAd({
            adUnitId: 'ca-app-pub-2103221276430615/2858924670', // Test Ad Unit ID
        });
