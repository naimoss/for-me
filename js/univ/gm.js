...
document.addEventListener('deviceready', async () => {
    ...
    try {
        ...
        banner = new admob.BannerAd({
            adUnitId: 'ca-app-pub-2103221276430615/6182474436', // Replace with your test or production Ad Unit ID
            size: { height: 60 }
        });
...
document.addEventListener('deviceready', async () => {
    ...
    try {
        // Initialize the InterstitialAd instance
        interstitial = new admob.InterstitialAd({
            adUnitId: 'ca-app-pub-2103221276430615/3847492112', // Test Ad Unit ID
        });
