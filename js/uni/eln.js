$('a#mob').each(function(){ this.href=this.href.replace('https://docs.google.com/open?id=', 'com.electronique.dz.univ&')});
$('a#mob').each(function(){ this.href=this.href.replace('https://drive.google.com/open?id=', 'com.electronique.dz.univ&')});

   window.onload = function() {
     Swal.fire({
  icon: 'error',
  title: '<a href="market://details?id=com.electronique.dz.univ" style=" font-family:exo 2;color: #000; ">Oops...</a>',
  ...
  footer: '<a href="market://details?id=com.electronique.dz.univ" style="font-size: large;color: #f00; ">Cliquez ici pour mettre à jour</a>'
})
    } ;
