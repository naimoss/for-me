...
function loadBanner() {
    if (typeof cordova !== 'undefined' && cordova.plugins && cordova.plugins.emiAdmobPlugin) {
        ...
        var Banner_ID = 'ca-app-pub-2103221276430615/2958081341'; // Test ID
...
document.addEventListener('deviceready', function () {
    let interstitial;
    const Interstitial_ID = 'ca-app-pub-2103221276430615/7632932681'; // Replace with actual Ad Unit ID
