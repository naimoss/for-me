$('a#mob').each(function(){ this.href=this.href.replace('https://docs.google.com/open?id=', 'com.genie.mecanique.dz.univ&')});
$('a#mob').each(function(){ this.href=this.href.replace('https://drive.google.com/open?id=', 'com.genie.mecanique.dz.univ&')});

   window.onload = function() {
     Swal.fire({
  icon: 'error',
  title: '<a href="market://details?id=com.genie.mecanique.dz.univ" style=" font-family:exo 2;color: #000; ">Oops...</a>',
  ...
  footer: '<a href="market://details?id=com.genie.mecanique.dz.univ" style="font-size: large;color: #f00; ">Cliquez ici pour mettre à jour</a>'
})
    } 

document.addEventListener('deviceready', function () {
    let interstitial;
    const Interstitial_ID = 'ca-app-pub-2103221276430615/3847492112'; // Replace with actual Ad Unit ID
